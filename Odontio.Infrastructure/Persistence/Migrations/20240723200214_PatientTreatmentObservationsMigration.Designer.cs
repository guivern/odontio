...
namespace Odontio.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20240723200214_PatientTreatmentObservationsMigration")]
    partial class PatientTreatmentObservationsMigration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Odontio.Domain.Entities.PatientTreatment", b =>
                {
                    ...
                    b.HasOne("Odontio.Domain.Entities.Diagnosis", "Diagnosis")
                        .WithMany("PatientTreatments")
